...
const OurTeam = () => {
    ...
    return (
        ...
        <section className='my-16 px-12 md:px-4  max-w-[1280px] m-auto'>
                    ...
                    {data.map(item => (
                        ...
                        <div key={item._id}>
                            <div className='flex flex-col items-center bg-[var(--gray)] '>
                                <img className='w-[140px] rounded-full p-3 mt-[-70px] bg-white' alt='team member' src={'http://localhost:4444/images/team/' + item.image} />
