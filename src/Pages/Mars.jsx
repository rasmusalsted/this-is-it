...

      {
        ...
        <div className='grid gap-12 md:grid-cols-2'>
          ...
          <div className='text-center text-gray-500 md:text-left md:max-w-[80%] relative'>
            ...
            <p className=' text-black  inline-block pb-3 mb-3 text-xl font-bold border-b-4 border-[var(--green)]'>{data[0].destination}</p>
            ...
            <p className='mb-8'>{parser(data[0].content)}</p>
