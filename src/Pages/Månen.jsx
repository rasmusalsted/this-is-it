...

            {
                ...
                <div className='grid gap-12 md:grid-cols-2'>
                    ...
                    <div className='flex flex-col gap-8 '>
                        <img className='object-cover w-full h-full' src={'http://localhost:4444/images/tours/' + data[1].image1} />
                        <img className='object-cover w-full h-full' src={'http://localhost:4444/images/tours/' + data[1].image2} />
                    </div>
                    ...
                    <div className='text-center text-gray-500 md:text-left md:max-w-[80%] relative'>
                        ...
                        <div className='py-8 border-y-2'>
                            <div className='m-auto text-left w-[250px] md:m-0'>
                                <p className='pb-3'><span className='font-bold text-black '>Destination: </span>{data[1].destination}</p>
                                <p className='pb-3'><span className='font-bold text-black '>Pris: </span>{data[1].price}</p>
                                <p className='pb-3'><span className='font-bold text-black '>Afstand fra jorden: </span>{data[1].distance}</p>
                                <p><span className='font-bold text-black '>Flyvetid: </span>{data[1].traveltime}</p>
                            </div>
                        </div>
